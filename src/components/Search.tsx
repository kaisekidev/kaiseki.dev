  ...
  if (collection.items.length === 0) {
    return (
      <p className="px-4 py-8 text-center text-sm text-neutral-700 dark:text-neutral-400">
        ...
        <span className="break-words text-neutral-900 dark:text-paper">
          {query}
        </span>
        &rdquo;
      </p>
  ...
  return (
    <div className="group relative flex h-12">
      ...
      <input
        ref={inputRef}
        className={clsx(
          'flex-auto appearance-none bg-transparent pl-12 text-neutral-900 outline-none placeholder:text-neutral-400 focus:w-full focus:flex-none sm:text-sm dark:text-paper [&::-webkit-search-cancel-button]:hidden [&::-webkit-search-decoration]:hidden [&::-webkit-search-results-button]:hidden [&::-webkit-search-results-decoration]:hidden',
  ...
  return (
    <>
      <button
        ...
        {...buttonProps}
      >
        <SearchIcon className="h-5 w-5 flex-none fill-dark md:fill-neutral-400 group-hover:fill-red-500 md:group-hover:fill-neutral-400 dark:fill-paper md:dark:fill-neutral-500" />
