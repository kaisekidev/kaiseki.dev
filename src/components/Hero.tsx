        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-indigo-200 via-red-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-normal text-transparent">
                Never miss the cache again.
              </p>
              <p className="mt-3 text-2xl tracking-normal text-neutral-400">
